...
4. **Presentation: February 8, 2021** (another session might be added if needed): In a joint session with Art 387, you are invited to present your technical solution in class in a short overview and then answer questions from your peers and instructors. Although you are not expected to complete your implementation by this point, you should have clearly and critically thought through the technical details, and be able to provide a more detailed summary of your concept.  
